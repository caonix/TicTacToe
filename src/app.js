...
var HelloWorldLayer = cc.Layer.extend({
    ...
    jugar: function(location, event){
        ...
        function updateScore(){
            ...
            juego.removeChild(juego.puntajeTies,1);
                ...
                if(juego.turn == 'X'){
                    //Labels
                    juego.LabelPlayerX = new cc.LabelTTF("Player 1 (X):", "Arial", 18);
                    juego.LabelPlayerX.x = 290;
                    juego.LabelPlayerX.y = 45;
                    juego.addChild(juego.LabelPlayerX, 1);
                    juego.LabelPlayer0 = new cc.LabelTTF("Player 2 (0):", "Arial", 18);
                    ...
                    juego.puntajeTies = new cc.LabelTTF(juego.ties, "Arial", 18);
    ...
    ctor:function () {
        ...
        this.LabelPlayerX = new cc.LabelTTF("Player 1 (X):", "Arial", 18);
        this.LabelPlayerX.x = 290;
        this.LabelPlayerX.y = 45;
        this.addChild(this.LabelPlayerX, 1);
        this.LabelPlayer0 = new cc.LabelTTF("Player 2 (0):", "Arial", 18);
        ...
        this.LabelTies = new cc.LabelTTF("Ties:", "Arial", 18);
